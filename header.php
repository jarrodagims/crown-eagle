                ...
                <div class="col-xs-12 navbar-button text-center">
                    <div class="navbar-left">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="menu-item directions"><a href="<?php echo get_site_url() ?>/contact-us/"><span>
                                        <?php if (!empty(get_option('sherpa_business_address'))) : echo get_option('sherpa_business_address'); endif; ?>
                                    </span></a></a></li>
